...
Generated: Tue, Mar 10, 2026  9:46:09 AM
...
src/_includes/components/menu-template.njk
src/_includes/components/services.njk
src/_layouts
src/_layouts/base.njk
```\n\n## FILE: src/_includes/components/menu-template.njk

```
{# ===== Component: Menu ===== #}

<section class="menu" aria-label="Menu-Template">
  <details>
    <summary class="menu-header">Menu</summary>
...
---\n\nKernel complete: kernel-20260310-094609.md\n