# kernel-0007 — Erasmus Project Snapshot

Generated: 2026-03-08T19:19:22Z

Project root: /c/Users/jerem/jchackett.me
Erasmus dir: /c/Users/jerem/jchackett.me/ERASMUS
...
## FILE: src/_includes/components/learn_more.njk
  ...
  <div class="learn-more-panels">
    ...
    <div class="learn-more-panel" id="lm-faq" role="region" aria-label="Learn More">
      <details class="faq-item">
        ...
        <p>I contract with Headway to accept a variety of insurances for my psychotherapy service.</p>
...
<div class="content-block">
  ...
  <p>
    For consulting, I charge a monthly subscription rate based upon the needs
    and required collateral work.
  </p>
</div>
...
<a class="button" href="/contact/">
  ...
  <ul>
    ...
    <p>Psychotherapy is focused on reducing the symoptoms of a diagnosable and clinically impressive mental health disorder. This includes moderate to severe anxiety or depression, a substance use disorder or other form of addiction, 
  </p>
  <hr class="blue-rule">
</details>
...
.button{
  ...
  font:500 1.05rem/1.2 "Linux Libertine","EB Garamond",serif;
  text-decoration:none;
...
.lm-faq-learn-more-panel p {
  margin: 0;
}

.lm-faq-learn-more-panel .button {
  margin: 0;
}

.lm-faq-learn-more-panel .blue-rule {
  margin: 2rem 0;
}
...
.learn-more .faq-item p + .insurance-list{
  margin-top:0;
}
...
.learn-more .faq-item[open] > summary {
  ...
  border-bottom: 2px dotted rgba(31, 78, 216, 0.35);
}
...
/* ===== Copy ===== */
.learn-more .faq-item p {
  margin: 0 0 0.8rem 0;
}

.learn-more .faq-item p:last-child {
  margin-bottom: 0;
}

/* ===== Insurance List ===== */
.learn-more .insurance-list{
  list-style:none;
  padding:0;
    display:grid;
...
```
{
  ...
  "tasks": [
    {
      "label": "Rebuild Erasmus Kernel",
      "type": "shell",
      "command": "${workspaceFolder}\\scripts\\rebuild-kernel.cmd",
      "group": {
        "kind": "build",
        "isDefault": true
      },
    ...
    },
    {
      "label": "Run Eleventy",
      "type": "shell",
      "command": "${workspaceFolder}\\run-eleventy.cmd",
      "problemMatcher": []
    }
  ]
}
...
## FILE: scripts/rebuild-kernel.cmd
...
Kernel complete: kernel-0007.md
